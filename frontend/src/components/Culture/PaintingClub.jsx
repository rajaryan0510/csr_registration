  ...
  return (
    ...
    <div>
      <div className='md:w-[400px] lg:mx-96 my-8'>
        ...
        <span className='font-medium text-2xl text-grey-800 hidden md:block'><small className='text-2xl text-red-600'>Painting</small> Club</span>
